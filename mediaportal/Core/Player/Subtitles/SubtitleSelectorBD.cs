...
namespace MediaPortal.Player.SubtitlesBD
{
  ...
  internal class SubtitleSelector
  {
    ...
    public SubtitleSelector(BDPlayer.ISubtitleStream dvbStreams, SubtitleRenderer subRender, SubtitleRenderer toto)
    ...
    private void RetrieveBitmapSubtitles()
    {
      ...
      try
      {
        ...
        {
          BDPlayer.SUBTITLE_LANGUAGE subLang = new BDPlayer.SUBTITLE_LANGUAGE();
    ...
    private BDPlayer.ISubtitleStream dvbStreams;
