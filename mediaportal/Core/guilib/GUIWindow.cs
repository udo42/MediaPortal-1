...
namespace MediaPortal.GUI.Library
{
  ...
  public class GUIWindow : ISupportInitialize, IDisposable
  {
    ...
    public enum Window
    {
      ...
      WINDOW_SETTINGS_GENERALMP = 1003,
      WINDOW_SETTINGS_SCREENSAVER = 1004,
      WINDOW_SETTINGS_THUMBNAILS = 1005,
      WINDOW_SETTINGS_ONSCREEN_DISPLAY= 1006,
      WINDOW_SETTINGS_VOLUME = 1007,
      WINDOW_SETTINGS_DYNAMIC_REFRESHRATE = 1008,
