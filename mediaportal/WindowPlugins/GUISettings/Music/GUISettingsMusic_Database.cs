  ...
  public class GUISettingsMusicDatabase : GUIInternalWindow
  {
    ...
    private void FolderScanThread()
    {
      ...
      if (null != dlgNotify)
      {
        ...
        dlgNotify.SetText(GUILocalizeStrings.Get(1479)); // Scan finished
    ...
    {
      GUIPropertyManager.SetProperty("#dateadded", "Set scan date in database: " + (string)_dateAdded[_dateAddedSelectedIndex]);
