  ...
  public class GUISettingsPicturesDatabase : GUIInternalWindow
  {
    ...
    protected override void OnClicked(int controlId, GUIControl control, Action.ActionType actionType)
    {
      ...
      if (control == btnScanDatabase)
      {
        if (scanShare == 0)
        {
          ...
          dlgOk.SetLine(1, GUILocalizeStrings.Get(1473)); // Nothing to scan
    ...
    private void OnScanDatabaseThread()
    {
      try 
      {
        ...
        SetStatus(GUILocalizeStrings.Get(1480));
        ...
        if (null != dlgNotify)
        {
          ...
          dlgNotify.SetText(GUILocalizeStrings.Get(1474));
    ...
    private void OnResetDatabase()
    {
      ...
      if (dlgYesNo != null)
      {
        ...
        dlgYesNo.SetLine(1, GUILocalizeStrings.Get(1475));
