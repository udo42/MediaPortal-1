...
namespace MediaPortal.GUI.Settings
{
  ...
  public class GUISettingsMusicNowPlaying : GUIInternalWindow
  {
    ...
    {
      GetID = (int)Window.WINDOW_SETTINGS_MUSICNOWPLAYING;
    }

    public override bool Init()
    {
      return Load(GUIGraphicsContext.Skin + @"\Settings_MyMusic_NowPlaying.xml");
    }
    ...
    {
      base.OnPageLoad();
      GUIPropertyManager.SetProperty("#currentmodule", "*Music - Now playing");
