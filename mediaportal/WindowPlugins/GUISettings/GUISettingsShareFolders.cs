...
namespace MediaPortal.GUI.Settings
{
  ...
  public class GUIShareFolders : GUIInternalWindow
  {
    ...
    private bool _shareCreateThumbs = false; // Future use
    ...
    protected override void OnClicked(int controlId, GUIControl control, Action.ActionType actionType)
    {
      ...
      if (control == btnReset)
      {
        ...
        if (dlgYesNo != null)
        {
          ...
          dlgYesNo.SetLine(1, GUILocalizeStrings.Get(1478)); // this will delete folders
    ...
    private void Update()
    {
      ...
      _shareCreateThumbs = FolderInfo(_shareFolderListItem).CreateThumbs;
        ...
        foreach (GUIListItem item in videosShareListcontrol.ListItems)
        {
          if (FolderInfo(item).Name.Equals(sName, StringComparison.InvariantCultureIgnoreCase))
          {
            ...
            if (dlgOk != null)
            {
              ...
              dlgOk.SetLine(1, GUILocalizeStrings.Get(1472));
              dlgOk.DoModal(GetID);
              OnAddEditFolder();
              return;
            }
    ...
    private void OnAddPath()
    {
      ...
      dlg.Reset();
      dlg.SetHeading(1278); // Folder browser
      dlg.EnableButton(true);
