...
namespace WindowPlugins.GUISettings
{
  public class GUISettingsGUISkipSteps : GUIInternalWindow
  {
    ...
    [SkinControl(22)] protected GUIButtonControl btnTimeoutValue = null;
    [SkinControl(23)] protected GUICheckButton btnRelative = null;
    [SkinControl(24)] protected GUICheckButton btnConstant= null;
    [SkinControl(25)] protected GUIButtonControl btnSkipValue = null;
    ...
    {
      return Load(GUIGraphicsContext.Skin + @"\settings_GUI_SkipSteps.xml");
    }
