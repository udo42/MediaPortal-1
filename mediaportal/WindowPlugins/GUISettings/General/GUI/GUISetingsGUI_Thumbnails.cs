    ...
    private void SetProperties()
    {
      switch (iQuality)
      {
        case 1:
          ...
          GUIPropertyManager.SetProperty("#thumbCompositing", "High Speed");
          GUIPropertyManager.SetProperty("#thumbInterpolation", "Nearest Neighbor");
          GUIPropertyManager.SetProperty("#thumbSmoothing", "None");
          GUIPropertyManager.SetProperty("#thumbScreen", "Small CRTs");
          break;
        case 2:
          GUIPropertyManager.SetProperty("#thumbResolution", Convert.ToString((int)Thumbs.ThumbResolution) + " + " +
                                        Convert.ToString((int)Thumbs.ThumbLargeResolution));
          GUIPropertyManager.SetProperty("#thumbCompositing", "High Speed");
          GUIPropertyManager.SetProperty("#thumbInterpolation", "Low");
          GUIPropertyManager.SetProperty("#thumbSmoothing", "High Speed");
          GUIPropertyManager.SetProperty("#thumbScreen", "Small wide CRTs, medium CRTs");
          break;
        case 3:
          GUIPropertyManager.SetProperty("#thumbResolution", Convert.ToString((int)Thumbs.ThumbResolution) + " + " +
                                        Convert.ToString((int)Thumbs.ThumbLargeResolution));
          GUIPropertyManager.SetProperty("#thumbCompositing", "Default");
          GUIPropertyManager.SetProperty("#thumbInterpolation", "Default");
          GUIPropertyManager.SetProperty("#thumbSmoothing", "Default");
          GUIPropertyManager.SetProperty("#thumbScreen", "Large wide CRTs, small LCDs");
          break;
        case 4:
          GUIPropertyManager.SetProperty("#thumbResolution", Convert.ToString((int)Thumbs.ThumbResolution) + " + " +
                                        Convert.ToString((int)Thumbs.ThumbLargeResolution));
          GUIPropertyManager.SetProperty("#thumbCompositing", "Assume Linear");
          GUIPropertyManager.SetProperty("#thumbInterpolation", "High Quality");
          GUIPropertyManager.SetProperty("#thumbSmoothing", "High Quality");
          GUIPropertyManager.SetProperty("#thumbScreen", "LCDs, Plasmas");
          break;
        case 5:
          GUIPropertyManager.SetProperty("#thumbResolution", Convert.ToString((int)Thumbs.ThumbResolution) + " + " +
                                        Convert.ToString((int)Thumbs.ThumbLargeResolution));
          GUIPropertyManager.SetProperty("#thumbCompositing", "High Quality");
          GUIPropertyManager.SetProperty("#thumbInterpolation", "High Quality Bicubic");
          GUIPropertyManager.SetProperty("#thumbSmoothing", "High Quality");
