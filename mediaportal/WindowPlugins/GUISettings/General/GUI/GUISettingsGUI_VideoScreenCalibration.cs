...
namespace MediaPortal.GUI.Settings
{
  ...
  public class GUISettingsMovieCalibration : GUIInternalWindow
  {
    ...
    {
      return Load(GUIGraphicsContext.Skin + @"\settings_GUI_VideoScreenCalibration.xml");
    }
        ...
        case (int)Controls.CONTROL_PIXEL_RATIO:
          {
            ...
            if (null != pControl)
            {
              ...
              pControl.SetPosition(iXOff + (iScreenWidth - iControlWidth) / 2,
                                   iYOff + (iScreenHeight - iControlHeight) / 2);
