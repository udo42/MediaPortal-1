...
namespace Mediaportal.TV.Server.TVLibrary.Implementations.Helper
{
  ...
  internal static class ComHelper
  {
    ...
    {
      //Load the dll
      IntPtr dllHandle = MediaPortal.Common.Utils.NativeMethods.LoadLibrary(dllName);
      ...
      IntPtr dllGetClassObjectPtr = MediaPortal.Common.Utils.NativeMethods.GetProcAddress(dllHandle, "DllGetClassObject");
