...
namespace Mediaportal.TV.Server.TVLibrary.Interfaces
{
  ...
  public enum CamType
  {
    ...
    /// Astoncrypt 2
    /// </summary>
    [Description("Astoncrypt 2")] Astoncrypt2 = 1
  }
  ...
  public enum AtscScteModulation
  {
    ...
    /// ATSC 8 VSB.
    /// </summary>
    [Description("8 VSB")] Atsc_8Vsb,

    /// <summary>
    /// ATSC 16 VSB.
    /// </summary>
    [Description("16 VSB")] Atsc_16Vsb,

    /// <summary>
    /// 64 QAM.
    /// </summary>
    [Description("64 QAM")] Scte_64Qam,

    /// <summary>
    /// 256 QAM.
    /// </summary>
    [Description("256 QAM")] Scte_256Qam
  }
  ...
  public enum CableModulation
  {
    ...
    /// 16 QAM.
    /// </summary>
    [Description("16 QAM")] Qam16,

    /// <summary>
    /// 32 QAM.
    /// </summary>
    [Description("32 QAM")] Qam32,

    /// <summary>
    /// 32 QAM.
    /// </summary>
    [Description("64 QAM")] Qam64,

    /// <summary>
    /// 128 QAM.
    /// </summary>
    [Description("128 QAM")] Qam128,

    /// <summary>
    /// 256 QAM.
    /// </summary>
    [Description("256 QAM")] Qam256,

    /// <summary>
    /// 512 QAM.
    /// </summary>
    [Description("512 QAM")] Qam512,

    /// <summary>
    /// 1024 QAM.
    /// </summary>
    [Description("1024 QAM")] Qam1024,

    /// <summary>
    /// 2048 QAM.
    /// </summary>
    [Description("2048 QAM")] Qam2048,

    /// <summary>
    /// 4096 QAM.
    /// </summary>
    [Description("4096 QAM")] Qam4096
  }
  ...
  public enum SatelliteModulation
  {
    ...
    /// BPSK.
    /// </summary>
    [Description("BPSK")] Psk2,

    /// <summary>
    /// QPSK.
    /// </summary>
    [Description("QPSK")] Psk4,

    /// <summary>
    /// 8 PSK.
    /// </summary>
    [Description("8 PSK")] Psk8,

    /// <summary>
    /// 16 [A]PSK.
    /// </summary>
    [Description("16 PSK")] Psk16,

    /// <summary>
    /// 32 [A]PSK.
    /// </summary>
    [Description("32 PSK")] Psk32,

    /// <summary>
    /// Offset QPSK (used for DigiCipher 2).
    /// </summary>
    [Description("Offset QPSK")] OffsetQpsk,

    /// <summary>
    /// Split-mode QPSK (used for DigiCipher 2).
    /// </summary>
    [Description("Split-mode QPSK")] SplitQpsk,
