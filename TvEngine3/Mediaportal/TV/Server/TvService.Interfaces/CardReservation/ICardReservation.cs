...
namespace Mediaportal.TV.Server.TVService.Interfaces.CardReservation
{
  public interface ICardReservation
  {
    ...
    TvResult CardTune(ITvCardHandler tvcard, ref IUser user, IChannel channel, Channel dbChannel,
                      ICardTuneReservationTicket ticket);

    TvResult Tune(ITvCardHandler tvcard, ref IUser user, IChannel channel, int idChannel,
                  ICardTuneReservationTicket ticket);
  }
}