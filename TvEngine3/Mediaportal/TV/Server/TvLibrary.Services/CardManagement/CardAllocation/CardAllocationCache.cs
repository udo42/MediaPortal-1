...
namespace Mediaportal.TV.Server.TVLibrary.CardManagement.CardAllocation
{
  ...
  {
    private static readonly IDictionary<int, IList<IChannel>> _tuningChannelMapping =
      new Dictionary<int, IList<IChannel>>();

    private static readonly IDictionary<int, IDictionary<int, bool>> _channelMapping =
      new Dictionary<int, IDictionary<int, bool>>();
    ...
    private static bool UpdateCacheWithChannelMapForChannel(int idChannel, int idCard,
                                                            bool? isChannelMappedToCard = null)
    {
