...
namespace Mediaportal.TV.Server.TVLibrary.Services
{
  public class ChannelGroupService : IChannelGroupService
  {
    ...
    public IList<ChannelGroup> ListAllChannelGroupsByMediaType(MediaTypeEnum mediaTypeEnum,
                                                               ChannelGroupIncludeRelationEnum includeRelations)
    {
      IList<ChannelGroup> listAllChannelGroupsByMediaType =
        ChannelGroupManagement.ListAllChannelGroupsByMediaType(mediaTypeEnum, includeRelations);
    ...
    {
      IList<ChannelGroup> listAllCustomChannelGroups =
        ChannelGroupManagement.ListAllCustomChannelGroups(includeRelations);
    ...
    {
      IList<ChannelGroup> listAllChannelGroupsByMediaType =
        ChannelGroupManagement.ListAllChannelGroupsByMediaType(mediaType);
      return listAllChannelGroupsByMediaType;
    }

    public ChannelGroup GetChannelGroupByNameAndMediaType(string groupName, MediaTypeEnum mediaType)
    {
      ChannelGroup channelGroupByNameAndMediaType = ChannelGroupManagement.GetChannelGroupByNameAndMediaType(groupName,
                                                                                                             mediaType);
