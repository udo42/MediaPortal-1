...
namespace Mediaportal.TV.Server.SetupTV.Sections
{
  public partial class TvTimeshifting : SectionSettings
  {
    ...
    {
      numericUpDownMinFiles.Value =
        ValueSanityCheck(ServiceAgents.Instance.SettingServiceAgent.GetValue("timeshiftMinFiles", 6), 3, 100);
      numericUpDownMaxFiles.Value =
        ValueSanityCheck(ServiceAgents.Instance.SettingServiceAgent.GetValue("timeshiftMaxFiles", 20), 3, 100);
      numericUpDownMaxFileSize.Value =
        ValueSanityCheck(ServiceAgents.Instance.SettingServiceAgent.GetValue("timeshiftMaxFileSize", 256), 20, 1024);
      numericUpDownWaitUnscrambled.Value =
        ValueSanityCheck(ServiceAgents.Instance.SettingServiceAgent.GetValue("timeshiftWaitForUnscrambled", 5), 1, 30);
      numericUpDownWaitTimeshifting.Value =
        ValueSanityCheck(ServiceAgents.Instance.SettingServiceAgent.GetValue("timeshiftWaitForTimeshifting", 15), 1, 30);
      numericUpDownMaxFreeCardsToTry.Value =
        ValueSanityCheck(ServiceAgents.Instance.SettingServiceAgent.GetValue("timeshiftMaxFreeCardsToTry", 0), 0, 100);
      numericParkedStreamTimeout.Value =
        ValueSanityCheck(ServiceAgents.Instance.SettingServiceAgent.GetValue("parkedStreamTimeout", 5), 1, 300);
    }
    ...
    public override void SaveSettings()
    {
      ...
      ServiceAgents.Instance.SettingServiceAgent.SaveValue("timeshiftWaitForUnscrambled",
                                                           (int) numericUpDownWaitUnscrambled.Value);
      ServiceAgents.Instance.SettingServiceAgent.SaveValue("timeshiftWaitForTimeshifting",
                                                           (int) numericUpDownWaitTimeshifting.Value);
      ServiceAgents.Instance.SettingServiceAgent.SaveValue("timeshiftMaxFreeCardsToTry",
