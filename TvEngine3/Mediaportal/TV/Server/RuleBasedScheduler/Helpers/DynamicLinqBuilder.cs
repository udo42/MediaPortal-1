...
namespace Mediaportal.TV.Server.RuleBasedScheduler.Helpers
{
    ...
    {     
      ...
      switch (conditionOperator)
      {
        ...
        case ConditionOperator.Contains:
          if (propertyValueString != null)
          {
            lambdaExpression = GetContainsExpression<Program>(propertyName, propertyValueString);
          }
          else
          {
        ...
        case ConditionOperator.NotContains:
          if (propertyValueString != null)
          {
            lambdaExpression = GetNotContainsExpression<Program>(propertyName, propertyValueString);
          }
          else
          {
        ...
        case ConditionOperator.StartsWith:
          if (propertyValueString != null)
          {
            lambdaExpression = GetStartsWithExpression<Program>(propertyName, propertyValueString);
          }
          else
          {
