  ...
  public class TvGuideBase : GuideBase, IMDB.IProgress
  {
    ...
    private void OnRecord()
    {
      ...
      else if (_useQuickRecordMenu)
      {
         ...
         quickRecordMenu.SetHeading(GUILocalizeStrings.Get(210093)); //200093=Quick record
        ...
        bool seriesLinkAvailable = (_currentProgram.SeriesId != "0");
         ...
         foreach (ScheduleRecordingType schedule in _quickRecordMenuSchedules)
         {
           ...
           switch (schedule)
           {
             ...
             case ScheduleRecordingType.SeriesLink:
               //  Record series
               scheduleDescription = GUILocalizeStrings.Get(210092);
               break;
         ...
         //  Programme info
         quickRecordMenu.AddLocalizedString(210094);
