...
namespace TvPlugin
{
  public abstract class GuideBase : GUIDialogWindow
  {
    ...
    protected int _channelOffset = 0;
    ...
    protected Channel _recordingExpected = null;
    protected DateTime _updateTimerRecExpected = DateTime.Now;
    protected IList<Schedule> _recordingList = new List<Schedule>();
    protected Dictionary<int, GUIButton3PartControl> _controls = new Dictionary<int, GUIButton3PartControl>();

    protected string _currentTitle = String.Empty;
    protected string _currentTime = String.Empty;
    protected bool _currentRecOrNotify = false;
    protected long _currentStartTime = 0;
    protected long _currentEndTime = 0;
    protected Program _currentProgram = null;
    protected bool _needUpdate = false;
    protected DateTime m_dtStartTime = DateTime.Now;
    protected int _programOffset = 0;
    protected int _totalProgramCount = 0;
    protected TvServer _server = null;
    protected IList<Program> _programs = null;

    protected int _backupCursorX = 0;
    protected int _backupCursorY = 0;
    protected int _backupChannelOffset = 0;

    protected DateTime _keyPressedTimer = DateTime.Now;
    protected string _lineInput = String.Empty;

    protected bool _byIndex = false;
    protected bool _showChannelNumber = false;
    protected int _channelNumberMaxLength = 3;
    protected bool _useNewRecordingButtonColor = false;
    protected bool _useNewPartialRecordingButtonColor = false;
    protected bool _useNewNotifyButtonColor = false;
    protected bool _recalculateProgramOffset;
    protected bool _useHdProgramIcon = false;
    protected string _hdtvProgramText = String.Empty;
    protected bool _guideContinuousScroll = false;

    // current minimum/maximum indexes
    //protected int MaxXIndex; // means rows here (channels)
    protected int MinYIndex; // means cols here (programs/time)
    ...
    protected void UpdateOverlayAllowed()
    {
    ...
    protected void PositionGuideCursorToCurrentChannel()
    {
      _cursorX = 0;
    ...
    protected void RenderSingleChannel(Channel channel)
    {
      string strLogo;
    ...
    protected void RenderChannel(ref Dictionary<int, List<Program>> mapPrograms, int iChannel, GuideChannel tvGuideChannel,
    ...
    protected int ProgramCount(int iChannel)
    {
      int iProgramCount = 0;
    ...
    protected void OnDown(bool updateScreen)
    {
      if (updateScreen)
      {
        UnFocus();
    ...
    protected void OnUp(bool updateScreen, bool isPaging)
    {
      if (updateScreen)
      {
        UnFocus();
    ...
    protected void SetBestMatchingProgram(bool updateScreen, bool DirectionIsDown)
    {
      // if cursor is on a program in guide, try to find the "best time matching" program in new channel
      int iCurY = _cursorX;
    ...
    protected void updateSingleChannelNumber()
    {
      // update selected channel
      if (!_singleChannelView)
      {
    ...
    protected void SetFocusBorder(ref GUIButton3PartControl button)
    {
    ...
    protected void CheckRecordingConflicts() { }
    ...
    protected long GetColorForProgram(Program program, bool onNow)
    {
    ...
    protected long GetColorFromString(string strColor)
    {
    ...
    protected bool IsMPAA(string classification)
    {
    ...
    protected void OnKeyCode(char chKey)
    {
    ...
    protected void ChangeChannelNr(int iChannelNr)
    {
      int iCounter = 0;
      bool found = false;
    ...
    /// </summary>
    protected string GetDuration(Program program)
    {
    ...
    protected string GetDurationAsMinutes(Program program)
    {
      if (program.Title == "No TVGuide data available")
      {
        return "";
    ...
    /// </summary>
    protected string GetStartTimeFromNow(Program program)
    {
    ...
    protected void setGuideHeadingVisibility(bool visible)
    {
    ...
    protected void setSingleChannelLabelVisibility(bool visible)
    {
      GUILabelControl channelLabel = GetControl((int)Controls.SINGLE_CHANNEL_LABEL) as GUILabelControl;
      GUIImage channelImage = GetControl((int)Controls.SINGLE_CHANNEL_IMAGE) as GUIImage;
    ...
    protected void LoadSkinSettings()
    {
      String temp;
    ...
    protected bool LoadGenreMap(Settings xmlreader)
    {
      int genreId;
      string genre;
    ...
    protected bool LoadGuideColors(Settings xmlreader)
    {
      List<string> temp;
    ...
    protected abstract string GetChannelLogo(string strChannel);
