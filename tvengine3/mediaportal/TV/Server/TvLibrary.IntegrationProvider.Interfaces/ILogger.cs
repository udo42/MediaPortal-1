...
namespace Mediaportal.TV.Server.TVLibrary.IntegrationProvider.Interfaces
{
  ...
  public interface ILogger
  {
    ...
    /// <param name="args">An array of objects to write using format.</param>
    void Debug(Type caller, string format, Exception ex, params object[] args);
    ...
    /// <param name="ex">The <see cref="Exception"/> that caused the message.</param>
    /// <param name="args">An array of objects to write using format.</param>
    void Info(Type caller, string format, Exception ex, params object[] args);
    ...
    /// <param name="ex">The <see cref="Exception"/> that caused the message.</param>
    /// <param name="args">An array of objects to write using format.</param>
    void Warn(Type caller, string format, Exception ex, params object[] args);
    ...
    /// <param name="ex">The <see cref="Exception"/> that caused the message.</param>
    /// <param name="args">An array of objects to write using format.</param>
    void Error(Type caller, string format, Exception ex, params object[] args);
    ...
    /// <param name="ex">The <see cref="Exception"/> that caused the message.</param>
    /// <param name="args">An array of objects to write using format.</param>
    void Critical(Type caller, string format, Exception ex, params object[] args);
